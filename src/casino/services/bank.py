...
class BankService:
    ...
    def request_transfer(
        ...
        source_table = dal_table.get_table(self.args, from_table, pool=self._pool)
        dest_table = dal_table.get_table(self.args, to_table, pool=self._pool)
    ...
    def get_all_balances(self) -> list[dict[str, Any]]:
        ...
        tables = dal_table.list_tables(self.args, pool=self._pool)
        result = []
        for t in tables:
